...
2. **שלמות מספרית — `docs/audits/AUDIT-2026-07-27-financial-integrity.md`** (46 ממצאים:
   ...
   🔴 **לפני קבוצה 3 — למדוד מחדש את שיעורי ה-`stop`.** 173 העסקאות שעליהן נשענו
   "61% בלי stop" ו"הטיית R 44%" נמחקו ב-27.07 (ראה ⚠️); המספרים בטלים.
   **"מחיקת 173 העסקאות" הושלמה ע"י המשתמש עצמו — לא נדרשת פעולה**
...
- **🔴 מסקנות האודיט שנשענו על שיעורי `stop` בטלות עד מדידה מחדש.** "61% מהעסקאות
  בלי `stop`" ו"הטיית R של 44%" נשענו כמעט כולן על 173 השורות שנמחקו. **כל מסקנה
  מספרית מהאודיט שנשענת על שיעורי `stop` חייבת להימדד מחדש לפני שקבוצה 3 מתוכננת** —
  התכנון הנוכחי מכויל להתפלגות שאינה קיימת עוד
