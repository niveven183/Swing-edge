...
**סטטוס:** אושר ובוצע 2026-07-27 — צעד 14 בוטל (ראה §10)
**בסיס:** `d5e90c8`
...
| ציר | הערכה |
|-----|--------|
| **משתמשים** | 🟢 **אפס משתמשים חיצוניים מושפעים.** שאילתת `auth.users` (2026-07-27, אחרי אישור התוכנית) מזהה את בעל 36 שורות הדמו כ-`niveven183@gmail.com` — **ניב עצמו**. 36/76 מעסקאותיו הסגורות אכן ייצאו מהסטטיסטיקה, וזו ההתנהגות הנכונה; אין למי להודיע. 9 המשתמשים האחרים: אפס שינוי. **הגרסה הראשונה של שורה זו דירגה 🔴 ובנתה סביבה צעד הודעה — על סמך הנחה, לא שאילתה.** ראה `docs/DECISIONS.md` 2026-07-27. |
...
| ~~14~~ | ~~הודעה למשתמש המושפע~~ | **בוטל** — המשתמש הוא ניב עצמו (`auth.users`, 2026-07-27) |
...
הסימן לצורך: יותר מ-36 עסקאות נעלמות מהסטטיסטיקה של החשבון שמחזיק את שורות הדמו.
