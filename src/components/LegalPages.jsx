...
export function PrivacyPage() {
  return (
    <LegalShell title="מדיניות פרטיות" updated="עודכן: יולי 2026">
      ...
      <Para lead="מה אנחנו אוספים:">(א) כתובת מייל וסיסמה מוצפנת — לצורך חשבון; (ב) נתוני העסקאות והיומן שאתה מזין — לתפעול השירות עבורך בלבד; (ג) נתוני שימוש אנונימיים (עמודים, ביצועים) — לשיפור המוצר; (ד) דיווחי שגיאות טכניים.</Para>
